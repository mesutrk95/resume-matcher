...
export const PDFBuilderProvider = ({
  ...
  const [instance, update] = usePDF({
    document: <ResumeDocument resume={resume} withIdentifiers={false} skipFont={false} />,
  });

  return <PDFBuilderContext.Provider value={instance}>{children}</PDFBuilderContext.Provider>;
};

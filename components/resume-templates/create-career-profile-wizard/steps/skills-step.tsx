...
export function SkillsStep({ selectedTitle, onSelectSkills, initialSkills = [] }: SkillsStepProps) {
  ...
  const suggestedSkills = selectedTitle ? skillsByTitle[selectedTitle] || defaultSkills : defaultSkills
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500">Add at least 5 strong skills that are relevant to your target position.</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex space-x-2">
          <Input
            ...
            className="flex-1"
          />
          <Button type="button" onClick={() => addSkill(inputValue)} disabled={!inputValue} size="icon">
        ...
        <div className="space-y-2 pt-4 border-t">
          <p className="text-sm font-medium">Suggested skills based on {selectedTitle || "your profile"}:</p>

...
type SkillCategoryItemProps = {
  ...
  onUpdateCategory: (categoryId: string, updates: Partial<ResumeSkillSet>) => void;
  onDeleteCategory: (categoryId: string) => void;
  onUpdateSkill: (skillId: string, categoryId: string, updates: Partial<ResumeSkillItem>) => void;
    ...
    <div ref={setNodeRef} style={style} className="space-y-2">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          {isEditing ? (
            ...
            <h3 className="text-md font-medium flex items-center">
              <span className={`${!skillSet.enabled ? "text-muted-foreground" : ""}`}>
                {skillSet.category}
              </span>
      ...
      <div
        className={`
          ...
          ${isDragging ? "border-primary bg-primary/5 border-dashed" : "border-muted-foreground/20 border-dashed"}
        `}
      >
        <SortableContext
        ...
        >
          {skillSet.skills.map((skill) => (
            <SkillItem
              ...
              onUpdate={(updates) => onUpdateSkill(skill.id, skillSet.category, updates)}

...
export function TitleStep({ onSelectTitle, initialTitle = '' }: TitleStepProps) {
  ...
  const [customTitle, setCustomTitle] = useState(
    jobTitles.includes(initialTitle) ? '' : initialTitle,
  );
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500">
          Select a job title from the list or enter a custom one. This will help us tailor your
          resume.
        </p>
      </div>
              ...
              <CommandList>
                <CommandEmpty>
                  <div className="p-2 text-sm">
                    No job title found. You can enter a custom title below.
                  </div>
                </CommandEmpty>
                <CommandGroup>
                  {jobTitles.map(title => (

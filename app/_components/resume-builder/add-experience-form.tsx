...
type AddExperienceFormProps = {
  onSave: (experience: { companyName: string; role: string; startDate: string; endDate: string }) => void
  onCancel: () => void
}
      ...
      <div className="p-6 pt-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <Input name="startDate" value={formData.startDate} onChange={handleChange} placeholder="e.g. Jan 2020" />
          </div>
          <div>
